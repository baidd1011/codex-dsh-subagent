...
需要：`agents` · `jobs` · `sessionPersistence` · `agentPresets` · `agentDefaultModel` · `permissionPresets`
...
来源：[`packages/mcp/mcp-agent-server/src/index.ts:94`](../packages/mcp/mcp-agent-server/src/index.ts)
